...
import com.synergygb.webAPI.exceptions.WebServiceException;

public class InvalidAppIdException extends WebServiceException {

    /**
     * Creates a new instance of <code>InvalidAppIdException</code> without detail message.
     */
    public InvalidAppIdException() {
    }

    /**
     * Constructs an instance of <code>InvalidInstrumentException</code> with the specified detail message.
