 ...
 * 
 */
package com.synergygb.billeteravirtual.core.services.params;
...
public class GeneralParams {
    public static final String COMMUNICATION_TYPE="commType";
    public static final String COMMUNICATION_DUMMY_TYPE_VALUE = "dummy";
