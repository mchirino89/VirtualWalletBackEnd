 ...
 * @version 1.0
 */
public class AuthenticationException extends LayerCommunicationException {
    
    public static String STATUS_CODE = "AUTHENTICATION_ERROR";
    
    public static String STATUS_MSG = "Invalid login or pass";
