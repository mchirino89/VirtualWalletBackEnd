 ...
 */
public class NonExistingUser extends LayerCommunicationException{
    
    public static String STATUS_CODE = "NON_EXISTING_USER_ERROR";
    
    public static String STATUS_MSG = "The user does not exists";
    
    public NonExistingUser(){
    }
    
    public NonExistingUser(String msg) {
        super(msg);
    }
